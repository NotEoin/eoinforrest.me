 ...
 *
 * Every `title` and `hook` below is the hero at the top of that project's
 * repository README — the tagline as the headline, the opening paragraph as
 * the standfirst — so the site and the repos say the same thing in the same
 * words.
 */
const ACTS: { slug: string; copy: ActCopy }[] = [
  {
    ...
    copy: {
      ...
      title: 'Give your boat a destination. It works out the rest.',
  ...
  },
  {
    ...
    copy: {
      ...
      title: 'Mood tracking that doesn’t feel like homework.',
  ...
  },
  {
    ...
    copy: {
      ...
      title: 'How many people are in this room? Ask their phones.',
  ...
  },
  {
    ...
    copy: {
      ...
      title: '“I am completely operational, and all my circuits are functioning perfectly.”',
  ...
  },
  {
    ...
    copy: {
      ...
      title: 'An assistant that remembers what you told it last week',
      hook: '…and never sends any of it anywhere. Hal runs a capable coding and research assistant entirely on your own GPU, and gives it long-term memory by wiring it into an Obsidian vault. Ask it questions about your own notes and it answers with citations you can click.',
